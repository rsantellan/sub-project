 ...
 */
final class Version20190730122320 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sub_fee ADD approved TINYINT(1) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE sub_inscription CHANGE level level SMALLINT DEFAULT NULL, CHANGE approved approved TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sub_fee DROP approved');
        $this->addSql('ALTER TABLE sub_inscription CHANGE level level SMALLINT DEFAULT NULL, CHANGE approved approved TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE sub_sections CHANGE position position SMALLINT DEFAULT NULL');
    }
}
